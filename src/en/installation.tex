...
\textbf{TeX~Live}\index{TeX distribution@{\TeX} distribution!TeX~Live} (\url{http://www.tug.org/texlive/}), a combination of teTeX, MacTeX and XEmTeX, is available for all three operating systems (Linux, macOS, Windows). Note that you need a reasonably recent version of TeX~Live (2012 or later at the time of writing) to use all features of {\Tw}.
